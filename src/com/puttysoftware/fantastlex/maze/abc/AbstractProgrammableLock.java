...
public abstract class AbstractProgrammableLock extends AbstractSingleLock {
	...
	if (this.isConditionallyDirectionallySolid(ie, dirX, dirY, inv)) {
		...
		FantastleX.getApplication().showMessage("You need a " + this.getKey().getName());
	    }
	}
    ...
    protected AbstractMazeObject readMazeObjectHook(final XDataReader reader, final int formatVersion)
	    throws IOException {
	final AbstractMazeObject o = FantastleX.getApplication().getObjects().readMazeObject(reader, formatVersion);
	if (o == null) {
