...
public abstract class AbstractTeleport extends AbstractMazeObject {
	...
	return FantastleX.getApplication().getMazeManager().getMaze().getPlayerLocationW();
    }
	...
	FantastleX.getApplication().showMessage(this.getName() + ": Destination (" + (this.destCol + 1) + ","
