...
public class ShockBomb extends AbstractBomb {
	...
	FantastleX.getApplication().getMazeManager().getMaze().radialScanShockObjects(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
	// Shock the ground, too
	FantastleX.getApplication().getMazeManager().getMaze().radialScanShockGround(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
    }
}
