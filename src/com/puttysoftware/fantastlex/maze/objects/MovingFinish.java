...
public class MovingFinish extends Finish {
	...
	this.active = true;
	this.activateTimer(FantastleX.getApplication().getMazeManager().getMaze().getFinishMoveSpeed());
    }
	...
	this.active = false;
	final AbstractMazeObject obj = FantastleX.getApplication().getMazeManager().getMazeObject(
		this.getDestinationRow(), this.getDestinationColumn(), this.getDestinationFloor(),
