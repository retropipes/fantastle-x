...
public class PoisonBomb extends AbstractBomb {
	...
	FantastleX.getApplication().getMazeManager().getMaze().radialScanPoisonObjects(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
	// Poison the ground, too
	FantastleX.getApplication().getMazeManager().getMaze().radialScanPoisonGround(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
    }
}
