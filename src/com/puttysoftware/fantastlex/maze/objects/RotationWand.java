...
public class RotationWand extends AbstractWand {
	...
	int r = 1;
	final String rres = CommonDialogs.showInputDialog("Rotation Radius:", "FantastleX", RotationWand.rChoices,
	...
	final String dres = CommonDialogs.showInputDialog("Rotation Direction:", "FantastleX", RotationWand.dChoices,
	...
	if (d) {
	    ...
	    FantastleX.getApplication().getGameManager().doCounterclockwiseRotate(r);
	}
