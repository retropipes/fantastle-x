...
public class UTurnTrap extends AbstractTrap {
	...
	FantastleX.getApplication().showMessage("Your controls are turned around!");
	FantastleX.getApplication().getGameManager().activateEffect(MazeEffectConstants.EFFECT_U_TURNED,
