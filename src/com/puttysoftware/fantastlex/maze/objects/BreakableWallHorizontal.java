...
public class BreakableWallHorizontal extends AbstractWall {
	...
	final int dirZ = FantastleX.getApplication().getMazeManager().getMaze().getPlayerLocationZ();
	...
	// Break up
	FantastleX.getApplication().getGameManager().morph(new Empty(), dirX, dirY, dirZ, MazeConstants.LAYER_OBJECT);
