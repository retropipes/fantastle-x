...
public class NameEditor extends AbstractObjectEditor {
	...
	this.cachedNames = FantastleX.getApplication().getScenarioManager().getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
	FantastleX.getApplication().getScenarioManager().getNamesFileManager().setNames(this.cachedNames);
    }

    @Override
    public void handleCloseWindow() {
	FantastleX.getApplication().getScenarioManager().getNamesFileManager().saveNames();
	this.exitEditor();
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("Edit Names")) {
			...
			me.create();
			FantastleX.getApplication().getScenarioManager().getNamesFileManager().loadNames();
			me.reSetUpGUI();
			me.edit();
		    }
