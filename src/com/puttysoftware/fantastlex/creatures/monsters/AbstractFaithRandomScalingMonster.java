...
abstract class AbstractFaithRandomScalingMonster extends AbstractFaithRandomMonster {
	...
	long minvar, maxvar;
	minvar = (long) (this.getLevel() * AbstractMonster.MINIMUM_EXPERIENCE_RANDOM_VARIANCE);
	maxvar = (long) (this.getLevel() * AbstractMonster.MAXIMUM_EXPERIENCE_RANDOM_VARIANCE);
