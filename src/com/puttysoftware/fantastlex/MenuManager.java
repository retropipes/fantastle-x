...
public class MenuManager {
	...
	final ArrayList<AbstractEditor> allEditors = FantastleX.getApplication().getAllEditors();
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("New...")) {
		    ...
		    final int result = CommonDialogs
			    .showConfirmDialog("Are you sure you want to reset the current level?", "FantastleX");
