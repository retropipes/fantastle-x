...
class GameGUIManager {
	...
	if (this.vwMgr == null) {
	    this.vwMgr = FantastleX.getApplication().getGameManager().getViewManager();
	    this.setUpGUI();
	}
    }
	...
	public void keyPressed(final KeyEvent e) {
	    final GameLogicManager glm = FantastleX.getApplication().getGameManager();
	...
	public void mouseClicked(final MouseEvent e) {
	    try {
		final GameLogicManager gm = FantastleX.getApplication().getGameManager();
		if (gm.usingAnItem()) {
		    final int x = e.getX();
		    final int y = e.getY();
