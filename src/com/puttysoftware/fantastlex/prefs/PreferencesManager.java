...
public class PreferencesManager {
	...
	return PreferencesManager.storeMgr.getBoolean("RandomBattleEnvironment", true);
    }
	...
	return PreferencesManager.storeMgr.getBoolean("CharacterChangesPermanent", true);
    }
	...
	try (BufferedInputStream bis = new BufferedInputStream(
	    ...
	    PreferencesManager.storeMgr.setBoolean("CharacterChangesPermanent", true);
	    PreferencesManager.storeMgr.setBoolean("SoundsEnabled", true);
	    PreferencesManager.storeMgr.setBoolean("RandomBattleEnvironment", true);
